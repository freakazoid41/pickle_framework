...
export default class PickleContext {
    /**
     * 
    ...
    constructor(obj) {
        ...
        //main container
        this.container = obj.c_container !== undefined ? obj.c_container : '.main_section';
    ...
    cleanMenu() {
        //each menu in dom
        const menu_items = document.body.querySelectorAll('.menuCont');
